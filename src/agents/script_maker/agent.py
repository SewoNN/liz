"""Script maker agent implementation."""
...
from src.agents.script_maker.prompts import SYSTEM_PROMPT
from src.agents.script_maker.tools import TOOLS
from src.configuration import Configuration


class ScriptMakerAgent(BaseReActAgent):
    """Script maker agent for generating creative scripts."""
    
    def __init__(self):
        """Initialize the script maker agent."""
        super().__init__(
            name="Script Maker Agent",
            description="An agent that generates creative scripts based on user input.",
            tools=TOOLS,
